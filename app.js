...
const { validationOfForm, jwtSign, sendVerificationEmail } = require('./utils/Validationutil');//validation page connecting
...
const PORT = process.env.PORT || 8000//there will be same servers the port hels to in creating server or we can use our server
const saltRound=10
...
const MONGO_URL = `mongodb+srv://vardhan123:siddhu1234@cluster0.exgj89v.mongodb.net/my-first-nodejs`//url from mongodb atlas
//connecting mongodb
...
const store = new mongoDbSession({
  ...
  app.use(
    session({
      secret: "This is your web server",
      resave: false,
